...
// SPIバスの設定
      ...
      cfg.pin_sclk = 1;//DC(D0);    // SPIのSCLKピン番号を設定 CLK 
      cfg.pin_mosi = 2;//DC(D1);    // SPIのMOSIピン番号を設定 SDA 
      cfg.pin_miso = -1;            // SPIのMISOピン番号を設定 (-1 = disable)
      cfg.pin_dc   = 4;//DC(D3)    // SPIのD/Cピン番号を設定   (-1 = disable) 
...
//*/
    ...
    { // 表示パネル制御の設定を行います。
      ...
      cfg.pin_rst          =    3;//(D2)  // RSTが接続されているピン番号  RESET (-1 = disable)
