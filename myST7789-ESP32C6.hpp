...
// SPIバスの設定
      ...
      cfg.spi_mode = 3;             // SPI通信モードを設定 (0 ~ 3) ESP32C6:2,3
      ...
      cfg.pin_sclk = 18;//19;//DC(D8);            // SPIのSCLKピン番号を設定 CLK 
      cfg.pin_mosi = 20;//18;//DC(D10);            // SPIのMOSIピン番号を設定 SDA 
      cfg.pin_miso = -1;            // SPIのMISOピン番号を設定 (-1 = disable)
      cfg.pin_dc   = 17;//DC(D7)//23;            // SPIのD/Cピン番号を設定   (-1 = disable) 
...
//*/
    ...
    { // 表示パネル制御の設定を行います。
      ...
      cfg.pin_rst          =    19;//20;//(D9)//16;  // RSTが接続されているピン番号  RESET (-1 = disable)
